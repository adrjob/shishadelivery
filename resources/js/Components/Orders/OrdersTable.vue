<template>
    <div class="overflow-hidden rounded-lg shadow-md dark:border-gray-700">
        ...
        <div v-if="showDialog" class="bg-slate-800 bg-opacity-50 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0">
            <div class="bg-white px-16 py-14 rounded-md text-center">
                <h1 class="text-xl mb-4 font-bold text-slate-500">Do you Want Delete?</h1>
                <button @click="showDialog = false" class="bg-red-500 px-4 py-2 rounded-md text-md text-white">Cancel</button>
