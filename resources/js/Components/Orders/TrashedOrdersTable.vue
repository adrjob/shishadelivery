                            ...
                            >
                                ...
                                >
                                    <path
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        d="M4 4v5h.582a7.37 7.37 0 00-.082-1A7 7 0 014 9V4zm12 5V4a7 7 0 015.834 5.834c-.132.958-.376 1.875-.706 2.748H20z"
                                    />
                                    <path
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        d="M12 20v-7.867a2.734 2.734 0 011.17-.177l.68-.068a6.5 6.5 0 10-6.204 7.825h.68v-5H4z"
                                    />
                                </svg>
                            </a>
                        </div>
...
function restoreOrder(id) {
    if (confirm("Are you sure you want to restore this order?")) {
        ...
        restoreForm.post(`/orders/${id}/restore`, {
